...
This is a slightly modified fork of Jeff Geerling's `mac-dev-playbook` introuducing some of my own custom roles to setup macOS to my preference.
...
## Installation
  ...
  4. Copy the `config.yml` from `iCloud/New Mac Setup/config.yml`
